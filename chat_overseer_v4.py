...
BITRIX_WEBHOOK      = "https://cosmosinsurance.bitrix24.ae/rest/8/c9du0pli0cvjn1c9"
...
class ChatAppClient:
    ...
    def save_credentials(self, email: str, password: str, app_id: str):
...
class FileViolationStrategy(ViolationStrategy):
    ...
    def _log(self, ctx: MessageContext, warning_sent: bool,
             time_sent: str, notification_sent: bool, deleted: bool):
        log = {
...
class WebSocketManager:
    ...
    def _send(self, ws, event: str, data=None):
...
def token_refresh_loop(chatapp: ChatAppClient, ws_manager: WebSocketManager):
    while True:
        time.sleep(1800)
        now            = int(time.time())
